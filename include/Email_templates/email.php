            ...
            <tr>
              <td style="padding:40px 30px 30px 30px;text-align:center;font-weight:bold;background: $Header_background_color;">
				<?php if($Email_header_image){ ?>
						<a href="#" style="text-decoration:none;"><img src=$Email_header_image width="125" alt="Logo" style="width:50%;max-width:125px;height:auto;border:none;text-decoration:none;color:#ffffff;"></a>
				<?php }  ?>
